...
class ABBot:
    ...
    def __init__(self, retriever, llm, filter):
        ...
        self.system_prompt = self.system_prompt = """
            You are a helpful, professional AI assistant working at ABB Robotics R&D.
            You help employees by answering questions about internal documentation, technical manuals, and systems like RobotStudio and RAPID.
            Use only the provided context to answer the question.
            Then use that to answer the question clearly and concisely.
            If unsure, say you don't know instead of making something up.
            If the question is not related to ABB, say you can't help with that.
        """
    ...
    def _filter_(self, query):
            ...
            weights = [1.0 - (i * 0.2) for i in range(len(contexts))]
            ...
            #print(context_scores_list)
            #print(ctx)
            if not context_scores_list:
                context_scores_list.append("No relevant context found.")
            else:
